...
public class UnsharpDialog extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UnsharpDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UnsharpDialog dialog = new UnsharpDialog(new javax.swing.JFrame(), true);
